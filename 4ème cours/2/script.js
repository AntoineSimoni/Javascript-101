...
planets.forEach(planet => {
    ...
    xhttp.open('GET', 'url' + planet , true);
    xhttp.send();
})
...
// Attention les clés json sont également en wookiee. Pour chaque clé json, si la valeur est primitive (string, number, etc),
// affichez la paire de clé/valeur.